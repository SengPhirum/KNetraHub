...
type EditableField = 'appName' | 'primaryColor' | 'logoHorizontalUrl' | 'logoIconUrl' | 'faviconUrl' | 'pwaIconUrl'
const FIELDS: EditableField[] = ['appName', 'primaryColor', 'logoHorizontalUrl', 'logoIconUrl', 'faviconUrl', 'pwaIconUrl']
