-- Legacy KNetraHub Monitoring schema (historical reference only)
-- Extracted 2026-07-16 from commit c135e432d815fb4d08a7622747c04d197530179e
-- Source: server/utils/db.ts (lines 253-763) and server/utils/metrics.ts (net/server hypertables).
-- DDL as embedded in code (idempotent bootstrap style, public schema).
-- The live database was not reachable at extraction time; this is the code-derived DDL.
...
-- ── Hypertables from server/utils/metrics.ts ──
